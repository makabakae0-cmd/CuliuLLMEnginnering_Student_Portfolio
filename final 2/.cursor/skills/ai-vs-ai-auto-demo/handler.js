...
const feature = {
    ...
    functions: [
        ...
        'buildInfectedHostAISnapshot',
        'decideInfectedHostActionAI',
        'normalizeInfectedHostAction',
        'getInfectedHostFallbackAction',
    ...
    pipeline: [
        ...
        { id: 'infection-commentary', reads: ['infection state'], writes: ['commentary panel'], requires: ['runInfectionDemoPhase', 'generateAICommentary'], produces: ['infection analysis'] },
        { id: 'infected-host-ai', reads: ['infected host snapshot', '/api/generate'], writes: ['infected host action history'], requires: ['buildInfectedHostAISnapshot', 'decideInfectedHostActionAI', 'runInfectedHostAIDemoLoop'], produces: ['visible survival reaction'] },
    ...
    inputs: ['demo entry buttons', 'setup defaults', 'spore AI output', 'host AI output', 'infected host AI output'],
    outputs: ['auto demo status', 'action highlights', 'spore highlights', 'host movement', 'infected host reactions', 'result screen'],
    validations: [
        { id: 'symbols-exist', category: 'existence', checks: ['keyFiles', 'domIds', 'functions', 'constants', 'styleClasses', 'backendRoutes'] },
        { id: 'demo-action-io', category: 'io', checks: ['fungus spores', 'host move|layer', 'infected move|layer|wait'] },
        { id: 'privacy', category: 'privacy', checks: ['fungus no host spawn', 'host no hidden spores'] },
        { id: 'ai-fallbacks', category: 'fallback', checks: ['spore fallback', 'host fallback', 'infected host fallback', 'local commentary'] },
